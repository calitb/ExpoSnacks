    ...
    <View style={styles.container}>
      <ActionRow title={`OBJETIVO`}>
        ...
        <Text style={styles.subtext}>
          (Debes tener una carta de ataque en tu mano que pueda usar tu
          luchador)
        </Text>
        {"\n"}
        {"\n"}
      ...
      <ActionRow title="COLOCA">
        ...
        <Text style={styles.subtext}>
          (Debe ser una carta de defensa que el oponente pueda usar)
        </Text>
        {"\n"}
        {"\n"}
      ...
      <ActionRow title="RESUELVE">
        <Text style={[styles.subtext, { fontWeight: "bold" }]}>
          Cualquier luchador cuya salud llega a 0 es derrotado y removido del
          tablero. Si esto termina el juego, se detiene la resolución del
          combate.
        </Text>
        {"\n"}
        {"\n"}
        ...
        <Text style={styles.subtext}>
          (Haz daño al defensor igual a la diferencia entre el valor del ataque
          y el valor de la defensa. Si el atacante hizo daño, gana el combate;
          en caso contrario el defensor gana el combate)
        </Text>
        {"\n"}
        {"\n"}
